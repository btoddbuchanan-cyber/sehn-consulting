      ...
      <div className="relative max-w-6xl mx-auto px-6 lg:px-8 pt-32 pb-24">
        <div className="max-w-3xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <a
              href="#services"
              className="inline-flex items-center justify-center border border-white/30 text-white font-semibold px-8 py-4 rounded text-base hover:bg-white/10 transition-colors"
            >
              Explore Services
            </a>
          </div>
