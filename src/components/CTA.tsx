        ...
        <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-lg p-8 sm:p-10 max-w-xl mx-auto">
          ...
          <div className="mt-8 pt-8 border-t border-white/20">
            <a
              ...
              className="inline-flex items-center justify-center w-full bg-white text-primary font-semibold px-8 py-4 rounded text-base hover:bg-gray-50 transition-colors"
            >
